...
export const SPEAKING_APPEARANCES: SpeakingAppearance[] = [
  ...
  {
    event: 'SLB Internal Training',
    topic: 'Testing in DevOps Teams',
    year: 'Nov 2019',
    location: 'SLB, Pune, India',
    type: 'Internal',
    audience: '15 attendees',
  },
  {
    event: 'PUNKS-2019 — SLB Knowledge Sharing',
    topic: 'Seven Habits of Highly Effective DevOps Teams',
    year: 'Dec 2019',
    location: 'SLB, Pune, India',
    type: 'Internal',
  ...
  {
    event: 'Accenture Internal Training',
    topic: 'Apigee Advanced Training',
    year: 'Sep 2019',
  ...
  {
    event: 'SRE Book Club',
    topic: 'Chapter 5 — Alerting on SLOs',
    year: 'Mar 2019',
    location: 'SLB, Pune, India',
    type: 'Internal',
    audience: '10 attendees',
  },
  {
    event: 'PUNKS-2019 — SLB Knowledge Sharing',
    topic: 'How to Build Trust Economies? (DLTs, DApps and Smart Contracts)',
    year: 'Feb 2019',
    location: 'SLB, Pune, India',
    type: 'Internal',
  },
  {
    event: 'SLB Internal Training',
    topic: 'VSTS Overview (2 sessions)',
    year: 'Feb 2019',
    location: 'SLB, Pune, India',
    type: 'Internal',
    audience: '20 attendees per session',
  },
  {
    event: 'SLB Internal — Scrum 101',
    topic: 'VSTS 101 (3 sessions)',
    year: 'Feb 2019',
    location: 'SLB, Pune, India',
    type: 'Internal',
    audience: '16 attendees per session',
  },
  {
  ...
  {
    event: 'KPI Workshop',
    topic: 'Functional, Non-functional & Process KPIs',
    year: 'Jan 2019',
    location: 'Pune, India',
    type: 'Workshop',
  },
  {
    ...
    topic: 'VSTS Overview',
    year: 'Jan 2019',
    location: 'SLB, Abu Dhabi, UAE',
    type: 'Internal',
    audience: '10 attendees',
  },
  {
    event: 'Project Advent — Super User Training',
    topic: 'VSTS for Project Advent Super Users',
    year: 'Nov 2018',
    location: 'Pune, India',
    type: 'Internal',
    audience: '20 attendees',
  ...
  {
    event: 'SLB Internal Training',
    topic: 'Test Lifecycle Management using Azure DevOps',
    year: 'Oct 2018',
    location: 'Pune, India',
    type: 'Internal',
    audience: '10 attendees',
  ...
  {
    event: 'Azure DevOps Essentials',
    topic: 'Azure DevOps Essentials — Boards, Repos, Pipelines & Test Plans',
    year: '2018',
    location: 'Pune, India',
    type: 'Internal',
    photoUrl: '/assets/img/gallery/Session-Azure-DevOps-Essentials.jpg',
  },
  {
    event: 'Blockchain Essentials',
    topic: 'Blockchain Fundamentals, Smart Contracts & DApps',
    year: '2018',
    location: 'Pune, India',
    type: 'Internal',
    photoUrl: '/assets/img/gallery/Session-Blockchain essentials.jpg',
  },
  {
    event: 'The 7 Cs of DevOps',
    topic: 'The 7 Cs — Continuous Integration, Delivery, Deployment, Quality, Compliance, Monitoring & Feedback',
    year: '2018',
    location: 'Pune, India',
    type: 'Internal',
    photoUrl: '/assets/img/gallery/Session-The journey of 7-Cs.jpg',
  },
];
...
export const GALLERY_IMAGES: GalleryImage[] = [
  ...
  { id: 13, title: 'APGI 2019 Conference',                    location: 'Pune, India',                src: '/assets/img/gallery/Session-APGI-2019-3.jpg' },
  { id: 14, title: 'APGI 2019 Conference',                    location: 'Pune, India',                src: '/assets/img/gallery/Session-APGI-Cnference-Achieving-Enterprise-wide-Aglity.jpg' },
  { id: 15, title: 'Global Azure Bootcamp 2019',              location: 'Pune, India',                src: '/assets/img/gallery/Session-Global-Azure-Bootcamp-2019-2.jpg' },
  { id: 16, title: 'Global Azure Bootcamp 2019',              location: 'Pune, India',                src: '/assets/img/gallery/Session-Global-Azure-Bootcamp-2019-3.jpg' },
  { id: 17, title: 'Global Azure Bootcamp 2019',              location: 'Pune, India',                src: '/assets/img/gallery/Session-Global-Azure-Bootcamp-4.jpg' },
  { id: 18, title: 'Global Azure Bootcamp 2019',              location: 'Pune, India',                src: '/assets/img/gallery/Session-Global-Azure-Bootcamp-2019-5.jpg' },
  { id: 19, title: 'Pune DevCon 2019',                        location: 'Pune, India',                src: '/assets/img/gallery/Session-DevCon-2019-2.jpg' },
  { id: 20, title: 'Azure DevOps Essentials',                 location: 'Pune, India',                src: '/assets/img/gallery/Session-Azure-DevOps-Essentials.jpg' },
  { id: 21, title: 'Blockchain Essentials',                   location: 'Pune, India',                src: '/assets/img/gallery/Session-Blockchain essentials.jpg' },
  { id: 22, title: 'The 7 Cs of DevOps',                      location: 'Pune, India',                src: '/assets/img/gallery/Session-The journey of 7-Cs.jpg' },
  { id: 23, title: 'The 7 Cs of DevOps',                      location: 'Pune, India',                src: '/assets/img/gallery/Session-The journey of 7-Cs-2.jpg' },
  { id: 24, title: 'The 7 Cs of DevOps',                      location: 'Pune, India',                src: '/assets/img/gallery/Session-The journey of 7-Cs-3.jpg' },
];
