    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white dark:bg-slate-800 p-6 rounded border border-slate-200 dark:border-slate-700">
          <h3 className="text-xl font-bold text-secondary-dark dark:text-secondary mb-2">1. Inform</h3>
        ...
        <div className="bg-white dark:bg-slate-800 p-6 rounded border border-slate-200 dark:border-slate-700">
          <h3 className="text-xl font-bold text-secondary-dark dark:text-secondary mb-2">2. Optimize</h3>
          <p className="text-sm text-slate-600 dark:text-slate-400">
        ...
        <div className="bg-white dark:bg-slate-800 p-6 rounded border border-slate-200 dark:border-slate-700">
          <h3 className="text-xl font-bold text-secondary-dark dark:text-secondary mb-2">3. Operate</h3>
          <p className="text-sm text-slate-600 dark:text-slate-400">
