    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white dark:bg-slate-800 p-6 rounded-lg border border-slate-200 dark:border-slate-700">
          <ShieldAlert className="w-8 h-8 text-secondary-dark dark:text-secondary mb-3" />
        ...
        <div className="bg-white dark:bg-slate-800 p-6 rounded-lg border border-slate-200 dark:border-slate-700">
          <Activity className="w-8 h-8 text-secondary-dark dark:text-secondary mb-3" />
        ...
        <div className="bg-white dark:bg-slate-800 p-6 rounded-lg border border-slate-200 dark:border-slate-700">
          <Users className="w-8 h-8 text-secondary-dark dark:text-secondary mb-3" />
